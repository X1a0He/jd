 ...
 * @LastEditTime: 2021-09-04 11:59:31
 * @LastEditors: Please set LastEditors
 * @Description: 批量取关京东店铺和商品，批量删除购物车内容
 */
const $ = new Env('批量取关店铺和商品&清空购物车');
...
//购物车内容
$.cart = false;
if (process.env.JD_CART.toLocaleLowerCase() === 'true') $.cart = true // 当环境变量中存在JD_CART并设置为true时才会执行删除购物车
